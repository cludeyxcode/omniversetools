...
export default function Base64() {
  ...
  useEffect(() => {
    document.title = 'Base64 Encoder / Decoder Online | OmniverseTools'
  }, [])
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <p className="text-gray-400 mb-6">
        Encode text to Base64 or decode Base64 strings online — free, instant, browser-based.
      </p>
      ...
      <div className="mt-10 text-sm text-gray-500 leading-relaxed">
        ...
        <p>
          Base64 is an encoding scheme that converts binary data to ASCII text. It's commonly used
          in email attachments, data URLs, and API authentication (e.g., Basic Auth headers).
          This tool uses the browser's native <code className="bg-zinc-800 px-1 rounded text-gray-300">btoa()</code> and{' '}
          <code className="bg-zinc-800 px-1 rounded text-gray-300">atob()</code> functions, with full Unicode support.
        </p>
      </div>
    </div>
  )
